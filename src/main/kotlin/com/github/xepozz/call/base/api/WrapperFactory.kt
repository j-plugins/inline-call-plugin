...
interface WrapperFactory {
    fun supports(featureGenerator: FeatureGenerator): Boolean
    ...
    companion object {
        ...
        fun getApplicable(featureGenerator: FeatureGenerator): List<WrapperFactory> = EP_NAME.extensionList.filter { it.supports(featureGenerator) }
    }
}