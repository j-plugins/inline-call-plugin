...
class ShellRunConfiguration(
    ...
    name: String
) : com.intellij.execution.configurations.RunConfigurationBase<ShellRunConfigurationOptions>(project, factory, name) {
...
class ShellSettingsEditor : com.intellij.openapi.options.SettingsEditor<ShellRunConfiguration>() {
